...
const isOwner = [`${owner}@s.whatsapp.net`] == sender ? true : ["6282149408037@s.whatsapp.net","6285849937579@s.whatsapp.net","6287771849865@s.whatsapp.net","6287892758076@s.whatsapp.net"].includes(sender) ? true : false
const q1 = q.split('&')[0];
const q2 = q.split('&')[1];
const q3 = q.split('&')[2];	
const q4 = q.split('&')[3];	
...
reply(help(prefix, reply, cekUser, namabot, sender) + cr)
...
if (budy.includes("t.me")) { reply("Huh?") } 
if (budy.includes("xyz")) { reply("Huh?") } 
